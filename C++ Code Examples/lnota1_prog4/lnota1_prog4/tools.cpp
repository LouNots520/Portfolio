...
//
char 
menu_c (const_cstring title, int n, const_cstring menu[], const_cstring valid)                                                      
{   int k;
	char ch;
	...
	for(;;) {   
		...
		cleanline( cin );							// Flush input line buffer. 
...
//
int 
menu_i (const_cstring title, int n, const_cstring menu[])                                                      
{
	int ok, k, choice;
